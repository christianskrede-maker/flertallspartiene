        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">
              Her samles omforente spesialmerknader. Der flertallet ikke har
              lagret en egen omforent tekst, vises kommunedirektørens forslag
              som base.
            </p>
          </div>
...
<div className="flex flex-col gap-2">
  <a
    href={`/saker/${id}/omforent-spesialmerknader/eksporter`}
  ...
  <a
    href={`/saker/${id}/omforent-spesialmerknader/eksporter-med-kommentarer`}
    className="w-fit rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium hover:bg-slate-50"
  >
