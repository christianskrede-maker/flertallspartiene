...
export async function GET(
  ...
  const dokumentInnhold: Paragraph[] = [
    new Paragraph({
      text: "Arbeidsutkast – spesialmerknader med kommentarer",
    ...
    dokumentInnhold.push(
      ...
      new Paragraph({
        children: [
          new TextRun({
            text: item.erLagret
              ? "Omforent spesialmerknad / arbeidsutkast"
              : "Kommunedirektørens spesialmerknad brukt som base",
            bold: true,
          }),
        ],
      }),
  ...
  return new NextResponse(body, {
    ...
    headers: {
      ...
      "Content-Disposition":
        'attachment; filename="arbeidsutkast-spesialmerknader-med-kommentarer.docx"',
    },
  });
}
